...
document.onload = (function runOnLoad() {
  fetch("./data.json")
    ...
    .then((data) => {
      //Remove this - create one div - and append allItemContainer to one div
...
*/
  ...
  */
      ...
      // let oldItems = localStorage.getItem("selectedProduct");
  ...
  ----------------------------------------------------
  */
      // let itemsInLocalStore = localStorage.getItem("selectedProduct");
